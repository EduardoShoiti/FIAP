...
idade_ao_lado = int(input("Digite a idade do colega ao lado: "))
minha_idade = int(input("Digite sua idade: "))

diferenca_idade = idade_ao_lado - minha_idade

print(f"A diferença de idade é de {diferenca_idade} anos")