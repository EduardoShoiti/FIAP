...
# Exercícios:
# 1)	Solicite um número do usuário. Diga a menor nota de real que é maior que este número. Caso não exista, diga “Este número é muito grande para ser pago com apenas 1 nota de real”
